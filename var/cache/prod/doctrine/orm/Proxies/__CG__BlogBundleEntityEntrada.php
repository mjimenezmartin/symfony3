 ...
 */
class Entrada extends \BlogBundle\Entity\Entrada implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BlogBundle\\Entity\\Entrada' . "\0" . 'id', '' . "\0" . 'BlogBundle\\Entity\\Entrada' . "\0" . 'titulo', '' . "\0" . 'BlogBundle\\Entity\\Entrada' . "\0" . 'contenido', '' . "\0" . 'BlogBundle\\Entity\\Entrada' . "\0" . 'status', '' . "\0" . 'BlogBundle\\Entity\\Entrada' . "\0" . 'image', '' . "\0" . 'BlogBundle\\Entity\\Entrada' . "\0" . 'categoria', '' . "\0" . 'BlogBundle\\Entity\\Entrada' . "\0" . 'usuario', 'entradaEtiqueta'];
        }
    ...
    public function addEntradaEtiqueta(\BlogBundle\Entity\Etiqueta $etiqueta)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addEntradaEtiqueta', [$etiqueta]);

        return parent::addEntradaEtiqueta($etiqueta);
    }
    ...
    public function getEntradaEtiqueta()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEntradaEtiqueta', []);

        return parent::getEntradaEtiqueta();
    }
