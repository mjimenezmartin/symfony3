...
class Usuario extends \BlogBundle\Entity\Usuario implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'BlogBundle\\Entity\\Usuario' . "\0" . 'id', '' . "\0" . 'BlogBundle\\Entity\\Usuario' . "\0" . 'nombre', '' . "\0" . 'BlogBundle\\Entity\\Usuario' . "\0" . 'password', '' . "\0" . 'BlogBundle\\Entity\\Usuario' . "\0" . 'email', '' . "\0" . 'BlogBundle\\Entity\\Usuario' . "\0" . 'rol', '' . "\0" . 'BlogBundle\\Entity\\Usuario' . "\0" . 'image', 'entrada'];
        }
    ...
    public function getEntrada()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getEntrada', []);
