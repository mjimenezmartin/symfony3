...
class appProdDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'app.twig_filter_vistas' => 'getApp_TwigFilterVistasService',
            ...
            'my.twig.extension' => 'getMy_Twig_ExtensionService',
    ...
    /**
     * Gets the 'app.twig_filter_vistas' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AppBundle\Twig\FilterVistas A AppBundle\Twig\FilterVistas instance
     */
    protected function getApp_TwigFilterVistasService()
    {
        return $this->services['app.twig_filter_vistas'] = new \AppBundle\Twig\FilterVistas();
    }
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('1iL+B0TO2D', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MR4JtuM9qZ', 0, 'TFlIgjhlQqhpxKKCHAHlli', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'topikapp', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_aa889bffea6370deb3228a2fd22df4b6959ebfa3d82d6ce74b4149d9c9aebfa3');
    ...
    /**
     * Gets the 'my.twig.extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \BlogBundle\Extensions\Twig\Helpers A BlogBundle\Extensions\Twig\Helpers instance
     */
    protected function getMy_Twig_ExtensionService()
    {
        return $this->services['my.twig.extension'] = new \BlogBundle\Extensions\Twig\Helpers($this->get('doctrine'));
    }
    ...
    {
        return $this->services['property_accessor'] = new \Symfony\Component\PropertyAccess\PropertyAccessor(false, false, \Symfony\Component\PropertyAccess\PropertyAccessor::createCache('CR5o8sNdNY', NULL, 'TFlIgjhlQqhpxKKCHAHlli', $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('BlogBundle\\Entity\\Usuario' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\BCryptPasswordEncoder', 'arguments' => array(0 => 4))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = new \Symfony\Component\HttpFoundation\RequestMatcher('^/etiqueta');

        $i = new \Symfony\Component\HttpFoundation\RequestMatcher('^/entrada');

        $j = new \Symfony\Component\Security\Http\AccessMap();
        $j->add($h, array(0 => 'ROLE_ADMIN'), NULL);
        $j->add($i, array(0 => 'ROLE_ADMIN', 1 => 'ROLE_USER'), NULL);
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('app.twig_filter_vistas'));
        $instance->addExtension($this->get('my.twig.extension'));
    ...
    {
        return $this->services['cache.annotations'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5IIEh6JJLD', 0, 'TFlIgjhlQqhpxKKCHAHlli', (__DIR__.'/pools'), $this->get('monolog.logger.cache'));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.our_db_provider'] = new \Symfony\Bridge\Doctrine\Security\User\EntityUserProvider($this->get('doctrine'), 'BlogBundle:Usuario', 'email', NULL);
    }
